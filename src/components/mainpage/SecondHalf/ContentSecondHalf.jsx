...
import Consequence from '../../icon/Consequence';
    ...
    return (
        <div className='Head-Inhaler-Container'>
            <div className='Inhaler-Container'>
                <IconInhaler1/>
                <h4 className='Text-Inhaler'>Ингаляционный антихолинергик</h4>
            ...
            <div className='Inhaler-Container'>
                <IconInhaler2/>
                <h4 className='Text-Inhaler'>Ингаляционный β2-агонист</h4>
            ...
            <div className='Inhaler-Container'>
                <IconInhaler3/>
                <h4 className='Text-Inhaler'>Ингаляционный глюкокортикостероид (ИГКС)</h4>
